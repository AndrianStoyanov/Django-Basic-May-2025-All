...
from posts.forms import PostBaseForm, PostCreateForm, PostEditForm, PostDeleteForm, SearchForm, CommentFormSet
...
#Simple example the Django the hood
# class MyView:
...
class Dashboard(ListView, TimeRestrictedMixin):
    model = Post
...
class DetailsPost(DetailView, FormMixin):
    model = Post
